  ...
  },
  {
    ...
    "caseStudy": [
      ...
      },
      {
        "type": "showcase",
        "label": "States & Matrix",
        "heading": "Two axes. Eight cells. Every interaction specified.",
        "body": "The interaction matrix lays out every combination of selection state (selected / unselected) × interaction state (default, hover, focused, disabled). Each cell is token-driven — no raw values, no interpretation needed at build time.",
        "image": {
          "src": "/images/projects/components-production-new/fragments/tab-matrix.svg",
          "alt": "Tab Button state matrix — all eight states across selected and unselected rows"
        },
        "caption": "Eight cells. Two rows. Every state references a design token.",
        "showcaseBg": "#0A0C14",
        "bg": "dark"
      },
      {
        "type": "screen-gallery",
        "label": "Anatomy · Keyboard · ARIA",
        "heading": "Every slot named. Every contract written.",
        "body": "Three extracts from the full spec: anatomy callouts for the active indicator and label slot, the WAI-ARIA keyboard interaction contract, and the ARIA attribute schema — role, aria-selected, aria-controls — applied at element level.",
        "screens": [
          {
            "image": {
              "src": "/images/projects/components-production-new/fragments/tab-anatomy.svg",
              "alt": "Tab Button anatomy — active indicator and label slot callouts"
            },
            "label": "Anatomy"
          },
          {
            "image": {
              ...
              "alt": "Tab Button keyboard contract — Left Right Home End Tab navigation"
            },
            "label": "Keyboard"
          },
          {
            "image": {
              ...
              "alt": "Tab Button ARIA contract — role tab, aria-selected, aria-controls"
            },
            "label": "ARIA"
          }
        ],
      ...
      },
      {
        "type": "showcase",
        "label": "Layout & Tokens",
        "heading": "Every measurement in tokens. Zero magic numbers.",
        "body": "The 64px container meets WCAG 2.5.5 touch target. Spacing follows the 4px grid throughout — tab width, gap, padding, and indicator height all trace back to named tokens.",
        "image": {
          "src": "/images/projects/components-production-new/fragments/tab-layout-spacing.svg",
          "alt": "Tab Button layout and spacing — all measurements annotated with design tokens"
        },
        "caption": "Touch-safe 64px container · four token references · no raw values",
        "showcaseBg": "#F7F9FB",
        "bg": "dark"
      },
      {
