...
export const Icons = {
  Utensils: (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
      <path d="m3 2 2 2" />
      <path d="m20 12-8 8-4-4 8-8z" />
      <path d="m15 11 3 3" />
      <path d="m19 15-3-3" />
      <path d="M12 21v-3" />
      <path d="M16 17v-3" />
      <path d="M20 13v-3" />
      <path d="M10 21H7a2 2 0 0 1-2-2V5" />
      <path d="M3 5h4" />
      <path d="M7 5 3 2" />
    </svg>
  ),
  Wine: (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
    ...
    >
      <path d="M8 22h8" />
      <path d="M7 10h10V5a5 5 0 0 0-10 0v5Z" />
      <path d="M12 15V22" />
      <path d="M12 15a5 5 0 0 0 5-5H7a5 5 0 0 0 5 5Z" />
    </svg>
  ),
  ...
  ChefHat: (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      ...
      {...props}
    >
      <path d="M6 13.8a4.41 4.41 0 0 1-2.9-4.2 4.5 4.5 0 0 1 8.9-1c.2 0 .4.1.6.1a4.5 4.5 0 0 1 8.9 1 4.41 4.41 0 0 1-2.9 4.2V20H6v-6.2Z" />
      <path d="M6 18h12" />
    </svg>
  ),
